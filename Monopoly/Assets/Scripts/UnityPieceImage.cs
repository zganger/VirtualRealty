...
/*
	void Update ()
	{
		...
		while (!movementFinished) {
			if ((transform.position.x + 5 >= GamePlay.GameBoard.getUnityCoords (Dest, 0) || transform.position.x - 5 <= GamePlay.GameBoard.getUnityCoords (Dest, 0)) && (transform.position.y + 5 >= GamePlay.GameBoard.getUnityCoords (Dest, 1) || transform.position.y - 5 <= GamePlay.GameBoard.getUnityCoords (Dest, 1))) {
...
*/
	...
	{
		movementFinished = true;
		if (!(transform.position.x + 5 >= GamePlay.GameBoard.getUnityCoords (Dest, 0) && transform.position.y + 5 >= GamePlay.GameBoard.getUnityCoords (Dest, 1))||(transform.position.x - 5 <= GamePlay.GameBoard.getUnityCoords (Dest, 0) && transform.position.y + 5 >= GamePlay.GameBoard.getUnityCoords (Dest, 1))||(transform.position.x + 5 >= GamePlay.GameBoard.getUnityCoords (Dest, 0) && transform.position.y - 5 <= GamePlay.GameBoard.getUnityCoords (Dest, 1))||(transform.position.x - 5 <= GamePlay.GameBoard.getUnityCoords (Dest, 0) && transform.position.y - 5 <= GamePlay.GameBoard.getUnityCoords (Dest, 1)))
		{
			movementFinished = false;
		}
