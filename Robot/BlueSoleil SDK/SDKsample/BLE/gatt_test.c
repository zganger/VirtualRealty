			...
			{
				{
					...
					BTUINT32 characteristic_id = 0;
					CharacteristicProperties.CharacteristicUuid.IsShortUuid = BTSDK_TRUE;
					CharacteristicProperties.CharacteristicUuid.ShortUuid = 0x2A37; //HeartRate measurement
					CharacteristicProperties.IsNotifiable = BTSDK_TRUE;
					pCharacteristicValue = (PBtsdkGATTCharacteristicValueStru)malloc(sizeof(BtsdkGATTCharacteristicValueStru) + 1);
					if (pCharacteristicValue != NULL)
					{
						memset(pCharacteristicValue, 0, sizeof(BtsdkGATTCharacteristicValueStru) + 1);
						pCharacteristicValue->DataSize = 2;
						pCharacteristicValue->Data[0] = 2;
						pCharacteristicValue->Data[1] = 0;
					}
					if (BTSDK_OK == Btsdk_GATTAddCharacteristic(serviceID, &CharacteristicProperties, pCharacteristicValue, &characteristic_id))
					{
						PBtsdkGATTDescriptorValueStru pDescriptorValue = NULL;
...

				{
					...
					BTUINT32 characteristic_id = 0;
					CharacteristicProperties.CharacteristicUuid.IsShortUuid = BTSDK_TRUE;
					CharacteristicProperties.CharacteristicUuid.ShortUuid = 0x2A38; //Body Sensor location
					CharacteristicProperties.IsReadable = BTSDK_TRUE;
					pCharacteristicValue = (PBtsdkGATTCharacteristicValueStru)malloc(sizeof(BtsdkGATTCharacteristicValueStru));
					if (pCharacteristicValue != NULL)
					{
						memset(pCharacteristicValue, 0, sizeof(BtsdkGATTCharacteristicValueStru));
						pCharacteristicValue->DataSize = 1;
						pCharacteristicValue->Data[0] = 1;
					}
					if (BTSDK_OK != Btsdk_GATTAddCharacteristic(serviceID, &CharacteristicProperties, pCharacteristicValue, &characteristic_id))
					{
						printf("GATT Server: Add Body Sensor Location characteristic failed.\r\n");
					}
					if (pCharacteristicValue != NULL)
					{
						free(pCharacteristicValue);
				...
				if (ret != BTSDK_OK)
				{
					printf("GATT Server:Add Heart Rate Measurement Service failed.\r\n");
				}		
			}
		}
		...
		//Health thermometer
		{
			...
			if (ret == BTSDK_OK)
			{
				//Temperature measurement
				{
					...
					BTUINT32 characteristic_id = 0;
					CharacteristicProperties.CharacteristicUuid.IsShortUuid = BTSDK_TRUE;
					CharacteristicProperties.CharacteristicUuid.ShortUuid = 0x2A1C; //Temperature measurement
					CharacteristicProperties.IsIndicatable = BTSDK_TRUE;
					pCharacteristicValue = (PBtsdkGATTCharacteristicValueStru)malloc(sizeof(BtsdkGATTCharacteristicValueStru) + 5);
					if (pCharacteristicValue != NULL)
					{
						memset(pCharacteristicValue, 0, sizeof(BtsdkGATTCharacteristicValueStru) + 5);
						pCharacteristicValue->DataSize = 6;
						pCharacteristicValue->Data[0] = 4;
						pCharacteristicValue->Data[5] = 4;
					}
					if (BTSDK_OK == Btsdk_GATTAddCharacteristic(serviceID, &CharacteristicProperties, pCharacteristicValue, &characteristic_id))
					{
						PBtsdkGATTDescriptorValueStru pDescriptorValue = NULL;
				...
				//Temperature Type 
				{
					...
					BTUINT32 characteristic_id = 0;
					CharacteristicProperties.CharacteristicUuid.IsShortUuid = BTSDK_TRUE;
					CharacteristicProperties.CharacteristicUuid.ShortUuid = 0x2A1D; //Temperature Type
					CharacteristicProperties.IsReadable = BTSDK_TRUE;
					pCharacteristicValue = (PBtsdkGATTCharacteristicValueStru)malloc(sizeof(BtsdkGATTCharacteristicValueStru));
					if (pCharacteristicValue != NULL)
					{
					...
					if (BTSDK_OK != Btsdk_GATTAddCharacteristic(serviceID, &CharacteristicProperties, pCharacteristicValue, &characteristic_id))
					{
						printf("GATT Server, add temperature type characteristic failed.\r\n");
					}
					if (pCharacteristicValue != NULL)
					{
						free(pCharacteristicValue);
			...
			{
				{
					...
					BTUINT32 characteristic_id = 0;
					CharacteristicProperties.CharacteristicUuid.IsShortUuid = BTSDK_TRUE;
					CharacteristicProperties.CharacteristicUuid.ShortUuid = 0x2A35; //BloodPressure measurement
					CharacteristicProperties.IsIndicatable = BTSDK_TRUE;
					pCharacteristicValue = (PBtsdkGATTCharacteristicValueStru)malloc(sizeof(BtsdkGATTCharacteristicValueStru) + 6);
					if (pCharacteristicValue != NULL)
					{
						memset(pCharacteristicValue, 0, sizeof(BtsdkGATTCharacteristicValueStru) + 6);
						pCharacteristicValue->DataSize = 7;
						pCharacteristicValue->Data[0] = 0;//flag
						pCharacteristicValue->Data[1] = 0;//c1
						pCharacteristicValue->Data[2] = 0;
						pCharacteristicValue->Data[3] = 0;//c1
						pCharacteristicValue->Data[4] = 0;
						pCharacteristicValue->Data[5] = 0;//c1
						pCharacteristicValue->Data[6] = 0;
					}
					if (BTSDK_OK == Btsdk_GATTAddCharacteristic(serviceID, &CharacteristicProperties, pCharacteristicValue, &characteristic_id))
					{
						PBtsdkGATTDescriptorValueStru pDescriptorValue = NULL;
						...
						if (pDescriptorValue != NULL)
						{
							...
							pDescriptorValue->DescriptorUuid.IsShortUuid = BTSDK_TRUE;
							pDescriptorValue->DescriptorUuid.ShortUuid = 0x2902;//
							pDescriptorValue->ClientCharacteristicConfiguration.IsSubscribeToIndication = TRUE;
						}
						if (BTSDK_OK != Btsdk_GATTAddDescriptor(characteristic_id, pDescriptorValue, &Permissions))
						{
							printf("GATT Server: Add Client Characteristic Configuration failed.\r\n");
				...
				{
					//Body Pressure Feature
					BtsdkGATTCharacteristicStru CharacteristicProperties = {0};
					PBtsdkGATTCharacteristicValueStru pCharacteristicValue = NULL;
					BTUINT32 characteristic_id = 0;
					CharacteristicProperties.CharacteristicUuid.IsShortUuid = BTSDK_TRUE;
					CharacteristicProperties.CharacteristicUuid.ShortUuid = 0x2A49; //Body Pressure Feature
					CharacteristicProperties.IsReadable = BTSDK_TRUE;
					pCharacteristicValue = (PBtsdkGATTCharacteristicValueStru)malloc(sizeof(BtsdkGATTCharacteristicValueStru) + 1);
					if (pCharacteristicValue != NULL)
					{
					...
					if (BTSDK_OK != Btsdk_GATTAddCharacteristic(serviceID, &CharacteristicProperties, pCharacteristicValue, &characteristic_id))
					{
						printf("GATT Server: Add Body Pressure Feature characteristic failed.\r\n");
					}
					if (pCharacteristicValue != NULL)
					{
						free(pCharacteristicValue);
			...
			{
				{
					...
					BTUINT32 characteristic_id = 0;
					CharacteristicProperties.CharacteristicUuid.IsShortUuid = BTSDK_TRUE;
					CharacteristicProperties.CharacteristicUuid.ShortUuid = 0x2A18; //BloodPressure measurement
					CharacteristicProperties.IsNotifiable = BTSDK_TRUE;
					pCharacteristicValue = (PBtsdkGATTCharacteristicValueStru)malloc(sizeof(BtsdkGATTCharacteristicValueStru) + 11);
					if (pCharacteristicValue != NULL)
					{
						memset(pCharacteristicValue, 0, sizeof(BtsdkGATTCharacteristicValueStru) + 11);
						pCharacteristicValue->DataSize = 12;
						pCharacteristicValue->Data[0] = 0;//flag,Date[3]~Date[9] is date_time
						pCharacteristicValue->Data[11] = 0;//c3
					}
					if (BTSDK_OK == Btsdk_GATTAddCharacteristic(serviceID, &CharacteristicProperties, pCharacteristicValue, &characteristic_id))
					{
						PBtsdkGATTDescriptorValueStru pDescriptorValue = NULL;
				...
				
				{
					...
					BTUINT32 characteristic_id = 0;
					CharacteristicProperties.CharacteristicUuid.IsShortUuid = BTSDK_TRUE;
					CharacteristicProperties.CharacteristicUuid.ShortUuid = 0x2A51; //Glucose Feature
					CharacteristicProperties.IsReadable = BTSDK_TRUE;
					pCharacteristicValue = (PBtsdkGATTCharacteristicValueStru)malloc(sizeof(BtsdkGATTCharacteristicValueStru) + 1);
					if (pCharacteristicValue != NULL)
					{
					...
					if (BTSDK_OK != Btsdk_GATTAddCharacteristic(serviceID, &CharacteristicProperties, pCharacteristicValue, &characteristic_id))
					{
						printf("GATT Server: Add Glucose Feature characteristic failed.\r\n");
					}
					if (pCharacteristicValue != NULL)
					{
						free(pCharacteristicValue);
...

				{
					...
					BTUINT32 characteristic_id = 0;
					CharacteristicProperties.CharacteristicUuid.IsShortUuid = BTSDK_TRUE;
					CharacteristicProperties.CharacteristicUuid.ShortUuid = 0x2A52; //Record Access Control Point
					CharacteristicProperties.IsWritable = BTSDK_TRUE;
					CharacteristicProperties.IsIndicatable = BTSDK_TRUE;
					pCharacteristicValue = (PBtsdkGATTCharacteristicValueStru)malloc(sizeof(BtsdkGATTCharacteristicValueStru) + 2);
					if (pCharacteristicValue != NULL)
					{
						memset(pCharacteristicValue, 0, sizeof(BtsdkGATTCharacteristicValueStru) + 2);
						pCharacteristicValue->DataSize = 3;
						pCharacteristicValue->Data[0] = 0;
						pCharacteristicValue->Data[1] = 0;
						pCharacteristicValue->Data[2] = 0;
					}
