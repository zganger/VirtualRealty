...
while(True):
	global HALF_TURN_DELAY,TURN_WAIT,TURN_DELAY,SPEED,DIST_COUNT,DIST_THRESHOLD,VEER_COUNT,LINE_COUNT,LINE_THRES,SIDE_COUNT,SPACE_COUNT,STOP_DELAY
	while(string == ""):
